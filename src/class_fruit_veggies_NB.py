...
class FruitsVeggiesNB(object):
    ...
    def roc_you_curve(self, X_train, X_test, y_train, y_test): 
        ...
        plot_roc_curve(model, X_test, y_test, name='ROC Curve for Color Images NB')
        plt.legend()
...
if __name__ == '__main__':
    ...
    # plot_both = fru_veg_class.plot_roc_conf(X_train, X_test, y_train, y_test)
