...
def scale_fruit(fruit_name):
    ...
    fruit_img_avg = avg_img(fruit_name)[1]
    fruit_name_middle = fruit_img_avg[30:40, 30:40]   
    ...
    fruit_name_gray = rgb2gray(fruit_img_avg)    
    print("Image shapes:")
    ...
    io.imsave('images/{}_avg_image_grayscale.png'.format(fruit_name), fruit_name_gray)
    plt.title('{} Average Image Grayscale'.format(fruit_name))
    plt.show()    
...
def plot_pixel_intensities(fruit_name, grayscale, thres, threshold):
    ...
    if grayscale:
       ...
       if thres:
        ...
        fruit_gray_color_values = avg_img(fruit_name)[1]    
...
def plot_kmeans(fruit_name):
    ...
    ## the 3 columns
    fruit_img_avg = avg_img(fruit_name)[0]  
    print(fruit_img_avg.reshape(-1,3).mean(axis=0)) #the average r,g,b value
    X = fruit_img_avg.reshape(-1,3)
...
if __name__ == '__main__':
    ...
    # plot_intense = plot_pixel_intensities('Pear')      

    ## plot kmeans
    # plot_km = plot_kmeans('Tomato')
    # plot_km = plot_kmeans('Pear')
